...
const fromStravaActivityToGinkgoActivity = (stravaActivity, userId, userInfo) => {
    ...
    stravaActivity.streams?.time?.data.forEach((t, index) => {
        ...
        geoBlock.speed = stravaActivity.streams?.altitude?.data[index];
