...
exports.fromStravaActivityToGinkgoActivity = void 0;
    ...
    try {
        ...
        if (stravaActivity.streams?.time?.data) {
            for (let counter = 0; counter < stravaActivity.streams?.time?.data?.length; counter++) {
                ...
                geoBlock.time = stravaActivity.streams?.time?.data[counter];
                ...
                if (stravaActivity.streams?.latlng?.data && stravaActivity.streams?.latlng?.data?.length > 0) {
                    geoBlock.lat = stravaActivity.streams?.latlng?.data[counter];
                    geoBlock.long = stravaActivity.streams?.latlng?.data[counter];
                    geoBlock.heading = counter > 0 && stravaActivity.streams?.time?.data[counter + 1] ? index_1.MAP.calcBearing(geoBlock.lat, geoBlock.long, stravaActivity.streams?.latlng?.data[counter + 1], stravaActivity.streams?.latlng?.data[counter + 1]) : 0;
                }
                ...
                if (stravaActivity.streams?.heartrate?.data && stravaActivity.streams?.heartrate?.data?.length > 0) {
                    ...
                    heartBlock.time = stravaActivity.streams?.time?.data[counter];
