...
const calcValues = (blocks) => {
  ...
  gpsMetrics.totalTime = (0, models_1.getMillisecondsBetweenTwoDates)(
...
const calcRanges = (blocks, settings) => {
  ...
  gpsMetrics.distanceRange = (0, models_1.calculateValueInRange)(
    gpsMetrics.totalDistance / 1000,
    settings.geoPosition.distanceRange,
  );
  return gpsMetrics;
};
