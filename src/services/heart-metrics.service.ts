...
export const calcAll = (blocks: ActivityBlocks, settings: ActivitySettings): Partial<HeartMetrics> => {
  return {
    ...calcValues(blocks),
...
export const calcValues = (blocks: ActivityBlocks): Pick<HeartMetrics, 'hrMax' | 'hrMin' | 'avgHr'> => {
...
export const calcRanges = (blocks: ActivityBlocks, settings: ActivitySettings): Pick<HeartMetrics, 'heartRanges'> => {
